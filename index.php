...
<div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
         ...
         <div class="outs-agile-buttn mt-lg-3 mt-2" style="background: black;">
    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <div class="card mb-4 box-shadow">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal"> <strong>Monthly <br>All Style Dance Style</strong></h4>
          </div>
...
₹ 2.5k One Time Registration </p>
        ...
        <div class="card mb-4 box-shadow">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal"> <strong>Monthly <br>Gymnastics Class Style</strong></h4>
          </div>
          <div class="card-body" style="background: #fb6509;">
          <p class="card-title">₹2k Monthly <br>
₹3k One Time Registration </p>
