...
<style>
   /* Sexy Register Button Styling */
.btn-register-sexy {
    background: linear-gradient(45deg, #f093fb 0%, #f5576c 100%); /* Vibrant Pink-Orange Gradient */
    ...
    font-size: 13px;
    letter-spacing: 1px;
    box-shadow: 0 4px 15px rgba(245, 87, 108, 0.4); /* Glow effect */
...
.btn-register-sexy:hover {
    ...
    color: white !important;
    background: linear-gradient(45deg, #f5576c 0%, #f093fb 100%); /* Reverse gradient on hover */
}
