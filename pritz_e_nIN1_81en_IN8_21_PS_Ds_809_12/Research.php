...
<?php
    ...
    if (!in_array($extension, ['pdf','doc','docx','PNG','JPG','png','jpg','xls','xlsx'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            $sql = "INSERT INTO puploads (name, pdfurl, tags, date) VALUES ('$name','./files/PDF/$filename','$tags','$created_date')";
...

{
    ...
    $sql = "UPDATE puploads  set Name='$name', Tags='$tags', Date='$created_date' where id='$uid'";
...

{
    ...
    $sql = "DELETE FROM puploads  where id='$uid'";
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h1 class="h3 mb-0 text-gray-800">PDF/ DOC/ JPG/ PNG</h1>
...
<!-- Area Chart -->
 ...
 <h6 class="m-0 font-weight-bold text-white">General PDF Management</h6>
                                ...
                                <div class="collapse show " id="messagedata">
                                    ...
                                    <form method="post" action="Research" enctype="multipart/form-data" style="padding:10px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" onkeyup="lettersOnly(this)" class="form-control" required   id="title"  >
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="Research" enctype="multipart/form-data" style="padding:10px;">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="update_name"  class="form-control" id="title" onkeyup="lettersOnly(this)" value="<?php echo $row['Name']; ?>"aria-describedby="emailHelp"  placeholder="Enter title">
