...
<?php
  ...
  if(hash_equals($csrf, $_POST['pritz']))
    ...
    if (!in_array($extension, ['pdf'])) {
     ...
     } elseif ($_FILES['myfile']['size'] > 700000000) { // file shouldn't be larger than 20Megabyte
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            $sql = "INSERT INTO bulletin_board (name, pdfurl, tags, date) VALUES ('$name','./files/PDF/$filename','$tags','$created_date')";
...
$tags = htmlentities($tags);
    ...
    $sql = "UPDATE bulletin_board set Name='$name', Tags='$tags', Date='$created_date' where id='$uid'";
...

{
    ...
    $sql = "DELETE FROM bulletin_board where id='$uid'";
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h1 class="h3 mb-0 text-gray-800">Updates and Notifications</h1>
...
<!-- Area Chart -->
 ...
 <h6 class="m-0 font-weight-bold text-white">Updates and Notifications/ Vaccancy</h6>
                                ...
                                <div class="collapse show " id="messagedata">
                                    ...
                                    <form method="post" action="updates" enctype="multipart/form-data" style="padding:10px;">

                                            <div class="form-group">

                                                <label for="sel1">Select Category Where You Want To Upload: <br> Vaccancy| Circulars</label>

                                                <select class="form-control" name="tags">
                                                <option>Circulars</option>

                                                    <option>Vaccancy</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control"  required   id="title"    title="No special characters allowed" />                                                                                        <input type="hidden" name="pritz" value="<?php echo $csrf; ?>">
                                    ...
                                    <form method="post" action="updates" enctype="multipart/form-data" style="padding:10px;">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <label for="sel1">Select Category Where You Want To Upload: <br> Circular or Vacancy</label>
