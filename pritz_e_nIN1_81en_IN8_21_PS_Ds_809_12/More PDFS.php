...

{
    ...
    $sql = "UPDATE uploads set Name='$name',Tags='$tags', Date='$created_date' where id='$uid'";
...

{
    ...
    $sql = "DELETE FROM uploads where id='$uid'";
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h1 class="h3 mb-0 text-gray-800">Outreach</h1>
...
<!-- Area Chart -->
 ...
 <h6 class="m-0 font-weight-bold text-white">Outreach Upload</h6>
                                    ...
                                    <form method="post" action="Outreach" enctype="multipart/form-data" style="padding:10px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="tags">
                                                    ...
                                                    <option>RTI Grieviances</option>
							<option>Downloads</option>



                                                    <option>Swach Bharat Abhiyaan</option>
...
<div class="card shadow mb-4">
    ...
    <a href="#dataprevious" class="d-block card-header py-3" data-toggle="collapse"
                                    ...
                                    <h6 class="m-0 font-weight-bold text-white">Outreach Management</h6>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered" id="bulletinboard" width="100%" cellspacing="0">
               ...
               <?php  
                    ...
                    $sql = "SELECT * FROM uploads where Tags IN ('TSP','SCSP')";  
